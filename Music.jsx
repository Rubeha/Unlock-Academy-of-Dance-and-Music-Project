    ...
    <div className="w-full">
      ...
      <section className="relative bg-black text-white h-[80vh] flex items-center justify-center">
        ...
        <div className="relative text-center z-10">
          ...
          <div className="space-x-4">
            <button className="px-6 py-3 bg-red-500 text-white rounded-xl shadow-lg hover:bg-red-600">
      ...
      <section className="p-10 text-center">
        ...
        <form className="max-w-md mx-auto space-y-4">
          ...
          <button className="w-full py-3 bg-blue-600 text-white rounded-lg">Sign Up</button>
        </form>
      </section>
