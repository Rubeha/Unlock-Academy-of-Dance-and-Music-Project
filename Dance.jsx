    ...
    <div className="w-full">
      ...
      <section className="relative bg-black text-white h-[80vh] flex items-center justify-center">
        ...
        <div className="relative text-center z-10">
          ...
          <button className="px-6 py-3 bg-pink-500 text-white rounded-xl shadow-lg hover:bg-pink-600">
      ...
      <section className="p-10 bg-gray-100">
        ...
        <div className="text-center mt-6">
          <button className="px-6 py-3 bg-green-500 text-white rounded-xl shadow-lg hover:bg-green-600">
      ...
      <section className="p-10 text-center">
        ...
        <div className="mt-6">
          <button className="px-6 py-3 bg-blue-500 text-white rounded-xl shadow-lg hover:bg-blue-600">
      ...
      <section className="p-10 bg-gray-100 text-center">
        ...
        <div className="space-x-4">
          <button className="px-6 py-3 bg-purple-500 text-white rounded-xl hover:bg-purple-600">
            Join In-Studio
          </button>
      ...
      <section className="p-10 bg-gray-100 text-center">
        ...
        <form className="max-w-md mx-auto space-y-4">
          ...
          <button className="w-full py-3 bg-blue-600 text-white rounded-lg">Submit</button>
        </form>
